...
/*   Updated: 2022/06/07 21:56:54 by seonkim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	var->image.image = mlx_new_image(var->mlx, SCREEN_WIDTH, SCREEN_HEIGHT);
...
int	cub3d_init(t_var *var, char *filename)
{
	...
	image_init(var);
	var->win = mlx_new_window(var->mlx, SCREEN_WIDTH, SCREEN_HEIGHT, "Cub3D");
	var->rand = 5;
	return (0);
}
